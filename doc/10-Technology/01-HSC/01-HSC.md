...
![](images/01-01.png){width="663" height="899"}
...
:::{attention}
对于高速计数器的相关硬件输入点，一般情况下需要设置其滤波时间，具体参见常见问题[链接](04-FAQ.md#高速计数器常见问题)。
:::
...
![](images/01-09.png){width="758" height="481"}
...
![](images/4.gif) 注意：：将 HSC 配置成计数模式时调用 CTRL_HSC/CTRL_HSC_EXT
...
![](images/01-13.png){width="774" height="492"}
...
![](images/4.gif) 注意：：将 HSC 配置成频率模式时调用 CTRL_HSC/CTRL_HSC_EXT
指令不是必须的。只要在硬件配置里使能并组态高速计数器即可正常计数，默认情况下
...
![](images/01-23.png){width="487" height="422"}

图 23. 软件门

![](images/4.gif) 注意：：硬件门功能仅可用在组态计数模式的 HSC
...
![](images/01-24.png){width="822" height="482"}
...
![](images/01-27.png){width="394" height="627"}

图 27. 修改初始值

![](images/4.gif) 注意：：CPU 启动后第一次计数时值为组态页面中的"初始计数器值"，参考图 5
...
![](images/01-28.png){width="816" height="506"}

图 28. 捕捉示例

捕捉外部输入组态，如图 29 所示。

![](images/01-29.png){width="735" height="756"}
...
![](images/01-30.png){width="394" height="625"}

图 30. 捕捉位及捕捉值

![](images/4.gif) 注意：： 必须调用 CTRL_HSC_EXT
...
![](images/4.gif) 注意：：需要更改参考计数值除了更改组态外还可以通过
