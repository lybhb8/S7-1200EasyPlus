...
:::{seealso} ![img](../../img/home/FAQ.png) 1.下载菜单中的下载到设备和扩展的下载到设备有什么区别?
...
:::{seealso} ![img](../../img/home/FAQ.png) 2.通过无线路由或远程通信无法搜索到CPU，该如何下载?
...
:::{seealso} ![img](../../img/home/FAQ.png) 3.什么情况下下载不会停机，什么情况下会停机?
...
:::{seealso} ![img](../../img/home/FAQ.png)  4. STEP 7 V13 SP1 编写的 S7-1200 V4.0项目，可以正常下载到 FS: 04 S7-1200 CPU，但是无法下载到 FS:05 S7-1200 CPU，ERROR 指示灯红色闪烁报错，CPU 无法启动 。为什么?
...
如果 STEP 7 V13 SP1 编写 的 S7-1200 V4.0项目使用了高数计数器功能，且实际使用的 S7-1200 CPU 版本是V4.2 FS:05， 则无法执行下载，CPU ERROR指示灯红色闪烁报错 ，CPU 无法启动。
