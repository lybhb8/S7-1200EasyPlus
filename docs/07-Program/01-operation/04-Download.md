...
:::{hint} ![img](../../img/home/FAQ.png) 1.下载菜单中的下载到设备和扩展的下载到设备有什么区别?
...
:::{hint} ![img](../../img/home/FAQ.png) 2.通过无线路由或远程通信无法搜索到CPU，该如何下载?
...
:::{hint} ![img](../../img/home/FAQ.png) 3.什么情况下下载不会停机，什么情况下会停机?
...
:::{hint}
![img](../../img/home/FAQ.png) 4. STEP 7 V13 SP1 编写的 S7-1200 V4.0项目，可以正常下载到 FS: 04 S7-1200 CPU，但是无法下载到 FS:05 S7-1200 CPU，ERROR 指示灯红色闪烁报错，CPU 无法启动 。为什么?
:::
